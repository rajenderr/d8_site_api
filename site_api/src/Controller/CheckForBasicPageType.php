...
/**
 * @file
 * Contains \Drupal\site_api\Controller\CheckForBasicPageType.
 */
...
class CheckForBasicPageType{
    ...
    public function checkForNode($site_api_key, NodeInterface $node){
        ...
        if($node->getType() == 'page' && $site_api_key != 'No API Key yet' && $site_api_key_value == $site_api_key){
